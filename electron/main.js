...
const INITIAL_DB_STATE = {
    ...
    roleConfigs: [
        { 
            ...
            roleName: 'ADMIN', 
            permissions: [
                'VIEW_DASHBOARD', 'MANAGE_USERS', 'VIEW_TURNOVER', 'VIEW_TURNOVER_DASHBOARD', 'ADD_TURNOVER', 
                'EDIT_TURNOVER', 'DELETE_TURNOVER', 'DELETE_PERIOD_TURNOVER', 'IMPORT_TURNOVER',
                'VIEW_CLEANING', 'VIEW_CLEANING_DASHBOARD', 'ADD_CLEANING', 'EDIT_CLEANING', 'DELETE_CLEANING', 'DELETE_PERIOD_CLEANING', 'IMPORT_CLEANING'
            ] 
        },
        { id: 'ESTATISTICA', roleName: 'ESTATISTICA', permissions: ['VIEW_DASHBOARD', 'VIEW_TURNOVER', 'VIEW_TURNOVER_DASHBOARD', 'EDIT_TURNOVER', 'VIEW_CLEANING', 'VIEW_CLEANING_DASHBOARD', 'EDIT_CLEANING'] },
